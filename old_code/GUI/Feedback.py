...
class Feedback(GridLayout, Screen):
    ...
    def __init__(self, **kwargs):
        ...
        self.add_widget(Label(text='[b][color=#FF7F00]Help & Feedback[/color][/b]', font_size=self.app.width / 28.8,
                              color=[1, 1, 1, 1],
        ...
        self.button_back = Button(text='[b]Back[/b]', font_size=self.app.width / 57.6, markup=True,
                                  on_press=self.home_screen_page)
        self.buttom.add_widget(self.button_back)

        self.button_contact = Button(text='[b]Contact Us[/b]', font_size=self.app.width / 57.6, markup=True,
