...
class DynamicWidget():
    ...
    def update_size_pos(self, instance, _):
        ...
        self.pos = (
        self.ratio_pos[0] * instance.width - self.size[0] / 4, self.ratio_pos[1] * instance.height - self.size[1] / 4)
...
class PlayerIcon(Label):
    ...
    border_color = ListProperty([0, 0, 0])  # rgb
    bg_color = ListProperty([1, 1, 1, 0])  # rgba
    inside_circle_color = ListProperty([1, 1, 1])  # rgb
